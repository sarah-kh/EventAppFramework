...
public class BrowserDriverFactory {
    ...
    public WebDriver createDriver() {
        ...
        switch (browser) {
            case "chrome":
                System.setProperty("webdriver.chrome.driver", "src/main/resources/file/chromedriver");
            ...
            case "chromeheadless":
                System.setProperty("webdriver.chrome.driver", "src/resources/file/chromedriver");
